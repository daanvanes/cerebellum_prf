...
mask_type = 'gray_matter'#gray_matter'#'cerebellum''wang'
fit_type = 'full'# fast
...
prf_nii.to_filename(opfn.replace('.nii.gz','%s_k%d.nii.gz'%(postFix,k)))
...
prf_nii.to_filename(opfn.replace('.nii.gz','%s_k%d_predictions.nii.gz'%(postFix,k)))
